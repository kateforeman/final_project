...
england_newly_diagnosed_cases %>% 
  ...
  labs(title = "Diagnosed Cases of malignant brain cancer in England", 
       subtitle = "2008-2017") + 
  xlab("Year") + 
...
updated_cancer_incidences %>% 
  ...
  geom_col() + 
  theme(axis.text.x = element_text(angle = 35, hjust = 0.9)) + 
  labs(title = "Crude Rate of Brain and CNS Tumours", subtitle = "2017") + 
  xlab("Health Board") + 
  ylab("Crude Rate") + 
  theme(
  plot.title = title.theme, 
...
survival_data %>% 
  ...
  filter(cancer_site_grouping == "Brain and other CNS Cancer") %>% 
