...
joined %>% 
  ...
  labs(title = "Brain and CNS Tumour and Leukaemia Net Survival over 2008-2012 and 2013-2017 (Male)", 
...
post_surgery_experience_2018 %>% 
  ...
  mutate(surgery_aftermaths = recode(surgery_aftermaths, "proportion_of_patients_die_within_30_days_of_surgery" = "Percentage of patients dying within 30 days", 
"proportion_of_patients_imaging_within_72_hours" = "Percentage of patients recieving brain imaging within 30 days")) %>% 
