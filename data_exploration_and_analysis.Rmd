...
scotland_incidences_all_types <- incidences %>% 
  filter(hb_label == "SCOTLAND") %>% 
  filter(age_label == "Number of registrations: All Ages") %>% 
  filter(site_label == c("Malignant brain cancer", "Malignant brain cancer (incl pituitary   gland, craniopharyngeal duct and pineal gland)", "Non-malignant brain cancer (incl pituitary gland, craniopharyngeal duct and pineal gland)")) %>% 
  filter(sex_label == "All Persons") 
