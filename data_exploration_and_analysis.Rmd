...
Net survival is an estimate of the probability that the average patient will be alive at a given time after diagnosis, after controlling for other causes of death. 
...
survival_data %>% 
  ...
  labs(title = "Males Net Survival over 2008-2012 and 2013-2017", 
...
survival_data %>% 
  ...
  geom_col() + 
  facet_wrap(~ calendar_period_of_diagnosis) + 
  labs(title = "Females Net Survival over 2008-2012 and 2013-2017", 
       subtitle = "Estimated probablity of survival for 1 year and 5 years after diagnosis") + 
  xlab("Years Since Diagnosis") + 
  ylab("Net Survival (%)") + 
  scale_y_continuous(breaks = seq(0, 50, by = 5)) 
...
survival_data %>% 
  ...
  ggplot(aes(calendar_period_of_diagnosis, deaths_within_10_years)) + 
  geom_col() + 
...
mortality %>% 
  ...
  geom_col() + 
  labs(title = "Yearly Deaths from Brain and CNS Cancer by Health Board", 
       subtitle = "1993 to 1999") + 
  xlab("Health Board") + 
